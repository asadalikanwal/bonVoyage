...
<form:form modelAttribute="newTrip" class="form-inline" method="post">
  ...
  <button type="submit" disabled style="display: none" aria-hidden="true"></button>
   ...
   <div class="form-group mb-2">
        ...
        <form:input  class="form-control" path="origin" id="origin-input" type="text" placeholder="Enter origin" style="width:250px;"/>
        <form:errors path="origin" cssClass="text-danger" />
   
   </div>
    <div class="form-group mx-sm-3 mb-2">
        <form:input  class="form-control" path="destination"  id="destination-input" type="text" placeholder="Enter destination" style="width:250px;"/>
    ...
    <div class="form-group mb-2">
        <span class="glyphicon glyphicon-map-marker"></span>     
        <form:input  class="form-control" path="originDate" id="start" type="date" style="width:250px;" placeholder="mm/dd/yyyy"/>
   </div>
    <div class="form-group mx-sm-3 mb-2">
        <form:input  class="form-control"  path="destinationDate" type="date" id="end" style="width:250px;" placeholder="mm/dd/yyyy"/>
    </div>
    
    <form:errors path="originDate" cssClass="text-danger" />
    <form:errors path="destinationDate" cssClass="text-danger" />
 ...
 <div id="formInput" class="hideView"> 
   <h3 align="center">One Last Step</h3>
        <p>
         ...
         <p>
           <form:input  path="fees" type="number" placeholder="Put number of Gallon" class="hideView" id="fee_gaz" min="1"/>
           <form:errors path="fees" cssClass="text-danger"/>
         </p>
         
        <%--  <p>
           <form:input path="fees"   type="number" placeholder="Put the amount" class="hideView" id="fee_money" min="1"/>
           <form:errors path="fees" cssClass="text-danger"/>
         </p> --%>
...
<script>
    ...
    function showHideFee() {
        ...
        if(gaz_choice.checked){
        	//document.getElementById("fee_money").style.display ="none";
        	document.getElementById("fee_gaz").placeholder     ="Put number of Gallon";
        }

        if(money_choice.checked){
        /* 	document.getElementById("fee_money").style.display ="block";
        	document.getElementById("fee_gaz").style.display   ="none"; */
/*         	document.getElementById("fee_gaz").style.display   ="block";
