...
<head>
    ...
    <script src="http://maps.google.com/maps/api/js?key=AIzaSyAPa16UTP31DOP2Yp688Tymq3DHGzSQ6kg&sensor=false"
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <form:form modelAttribute="searchTrip" action="search_Trip" method="post" class="form-inline">
                ...
                <div class="form-group mb-2">
                    ...
                    <form:input path="origin_search" type="text" class="form-control" id="origin_search"
                                placeholder="Origin"/>
                    <form:errors path="origin_search" cssClass="text-danger"/>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <form:input path="destination_search" type="text" class="form-control" id="destination_search"
